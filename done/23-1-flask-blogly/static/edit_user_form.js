...
$('#cancel').on('click', function (e) {
    $('#form').prop('action', `/users`);    // record the answer to current question
    console.log("click : cancel")
})

$('#delete').on('click', function (e) {
    let user_id = parseInt($('#init_user_id').val());
    $('#form').prop('action', `/users/${user_id}/delete`);    // record the answer to current question
    console.log("click : delete")
})

$('#submit').on('click', function (e) {
    let user_id = parseInt($('#init_user_id').val());
    $('#form').prop('action', `/users/${user_id}/edit`);    // record the answer to current question
