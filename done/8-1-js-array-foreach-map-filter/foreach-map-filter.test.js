...
describe("#doubleValues", function () {
   it("double values in an array", function () {
      expect(doubleValues([1, 2, 3])).toEqual([2, 4, 6]);
   });
   it("double negative numbers", function () {
      expect(doubleValues([-1, -2, -3])).toEqual([-2, -4, -6]);
   });
   it("double 0 equals 0", function () {
      expect(doubleValues([0, 0, 0])).toEqual([0, 0, 0]);
   });
   it("double decimal numbers", function () {
      expect(doubleValues([1.2, 2.9, 3.5])).toEqual([2.4, 5.8, 7.0]);
   });
   it("double large numbers", function () {
      expect(doubleValues([10000, 20000, 30000])).toEqual([
         20000, 40000, 60000,
      ]);
   });
});
